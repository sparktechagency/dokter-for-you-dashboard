...
const ViewSinglePharmacyMedicine = () => {
    return (
        <div className="bg-white p-6 ">
            <BackButton />
            <h2 className="text-lg font-bold mb-6 text-gray-800 text-start">Medication single Details</h2>
...
export default ViewSinglePharmacyMedicine;
