...
const AdminDetailsModal = ({open , setOpen , viewShippingProfile}:{open:boolean , setOpen:(open:boolean)=>void , viewShippingProfile:any}) => { 
                       ...
                       <div className="flex-1">
                           <div className="flex items-center justify-between">
                               <div>
                                   ...
                                   <p className="text-green-500"> Jr. Administrator</p>
                               </div>
