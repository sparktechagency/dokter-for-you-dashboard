import { Badge, Button, DatePicker, Input, Select, Table, Tooltip } from "antd";
    ...
    const Columns = [
        ...
        },
        {
            ...
            render: (status: string) => (
                <div>
                    <button className={`${status === "Resented" ? "bg-[#FFBE00]" : "bg-[#1854F9]"} text-white text-[14px] py-1.5 px-2 rounded-md`}>{status}</button>
                </div>
            ),
        },
        {
